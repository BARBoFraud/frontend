...
struct HTTPClient {
    ...
    func UserRegistration(name:String, lastName1:String, lastName2:String,email:String, password:String) async throws {
        ...
        guard let url = URL(string: "http://localhost:4000/v1/users/register") else {
    ...
    func UserLogin(email:String, password:String) async throws -> LoginResponse{
        ...
        guard let url = URL(string: "http://localhost:4000/v1/auth/users/login") else {
    ...
    func UserLogOut(refreshToken: String) async throws {
        ...
        guard let url = URL(string: "http://localhost:4000/v1/auth/users/logout") else {
    ...
    func DeactivateUser() async throws {
        guard let url = URL(string: "http://localhost:4000/v1/users/deactivate") else {
